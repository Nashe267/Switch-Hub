        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description">Company registration number (displayed under logo)</p>
                </td>
            </tr>
            <tr>
                <th scope="row"><label for="sbha_csd_number">CSD Number</label></th>
                <td>
                    <input type="text" id="sbha_csd_number" name="sbha_csd_number" value="<?php echo esc_attr(get_option('sbha_csd_number')); ?>" class="regular-text">
                    <p class="description">CSD registration number (displayed under logo)</p>
                </td>
            </tr>
            <tr>
        ...
        jQuery(document).ready(function($) {
            ...
            $('.sbha-upload-btn').on('click', function(e) {
                ...
                mediaUploader.on('select', function() {
                    ...
                    $('#img_' + target).val(attachment.url);
                    $('#preview_' + target).html('<img src="' + attachment.url + '" alt="Preview">');
                });
